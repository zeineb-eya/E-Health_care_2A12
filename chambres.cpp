...
QSqlQueryModel* Chambres::TriCASC()
{
  QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Chambres::TriCDES()
{
  QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Chambres::TriCASC1()
{
  QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Chambres::TriCDES1()
{
  QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Chambres::TriCASC2()
{
  QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Chambres::TriCDES2()
{
  QSqlQueryModel* model=new QSqlQueryModel();
