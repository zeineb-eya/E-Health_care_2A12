...
public:
    ...
    QLabel *label_36;
    QLabel *label_37;
    QComboBox *language_4;
    QComboBox *voice_4;
    QSlider *volume_4;
    QWidget *layoutWidget;
    QHBoxLayout *horizontalLayout_4;
    QPushButton *speakButton_4;
    QPushButton *pauseButton_4;
    QPushButton *resumeButton_4;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget_7->setGeometry(QRect(0, 0, 891, 491));
        tab_20 = new QWidget();
...
"}"));
        ...
        layoutWidget_2->setGeometry(QRect(20, 230, 611, 201));
        ...
        rate_4 = new QSlider(layoutWidget_2);
        rate_4->setObjectName(QStringLiteral("rate_4"));
        rate_4->setMinimum(-10);
        rate_4->setMaximum(10);
        rate_4->setOrientation(Qt::Horizontal);

        gridLayout_4->addWidget(rate_4, 2, 2, 1, 1);

        engine_4 = new QComboBox(layoutWidget_2);
        engine_4->setObjectName(QStringLiteral("engine_4"));
        QSizePolicy sizePolicy1(QSizePolicy::Expanding, QSizePolicy::Fixed);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(engine_4->sizePolicy().hasHeightForWidth());
        engine_4->setSizePolicy(sizePolicy1);
        engine_4->setStyleSheet(QLatin1String("QPushButton {\n"
"padding: 5px;\n"
"border-radius: 5px;\n"
"background-color:#0094ff;\n"
"font-weight: bold;\n"
...
"}"));
        ...
        gridLayout_4->addWidget(engine_4, 4, 2, 1, 1);
        ...
        pitch_4 = new QSlider(layoutWidget_2);
        pitch_4->setObjectName(QStringLiteral("pitch_4"));
        pitch_4->setMinimum(-10);
        pitch_4->setMaximum(10);
        pitch_4->setSingleStep(1);
        pitch_4->setOrientation(Qt::Horizontal);

        gridLayout_4->addWidget(pitch_4, 3, 2, 1, 1);
        ...
        language_4 = new QComboBox(layoutWidget_2);
        language_4->setObjectName(QStringLiteral("language_4"));
        sizePolicy1.setHeightForWidth(language_4->sizePolicy().hasHeightForWidth());
        language_4->setSizePolicy(sizePolicy1);
        language_4->setStyleSheet(QLatin1String("QPushButton {\n"
"padding: 5px;\n"
"border-radius: 5px;\n"
"background-color:#0094ff;\n"
"font-weight: bold;\n"
...
"}"));
        ...
        gridLayout_4->addWidget(language_4, 5, 2, 1, 1);

        voice_4 = new QComboBox(layoutWidget_2);
        voice_4->setObjectName(QStringLiteral("voice_4"));
        voice_4->setStyleSheet(QLatin1String("QPushButton {\n"
"padding: 5px;\n"
"border-radius: 5px;\n"
"background-color:#0094ff;\n"
"font-weight: bold;\n"
...
"}"));
        ...
        gridLayout_4->addWidget(voice_4, 6, 2, 1, 1);

        volume_4 = new QSlider(layoutWidget_2);
        volume_4->setObjectName(QStringLiteral("volume_4"));
        volume_4->setMaximum(100);
        volume_4->setSingleStep(5);
        volume_4->setPageStep(20);
        volume_4->setValue(70);
        volume_4->setOrientation(Qt::Horizontal);

        gridLayout_4->addWidget(volume_4, 1, 2, 1, 1);

        layoutWidget = new QWidget(tab_3);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(50, 0, 320, 25));
        horizontalLayout_4 = new QHBoxLayout(layoutWidget);
        horizontalLayout_4->setObjectName(QStringLiteral("horizontalLayout_4"));
        horizontalLayout_4->setContentsMargins(0, 0, 0, 0);
        speakButton_4 = new QPushButton(layoutWidget);
        speakButton_4->setObjectName(QStringLiteral("speakButton_4"));
        speakButton_4->setStyleSheet(QLatin1String("QPushButton {\n"
"padding: 5px;\n"
"border-radius: 5px;\n"
"background-color:#0094ff;\n"
"font-weight: bold;\n"
...
""));
        ...
        horizontalLayout_4->addWidget(speakButton_4);

        pauseButton_4 = new QPushButton(layoutWidget);
        pauseButton_4->setObjectName(QStringLiteral("pauseButton_4"));
        pauseButton_4->setEnabled(false);
        pauseButton_4->setStyleSheet(QLatin1String("QPushButton {\n"
"padding: 5px;\n"
"border-radius: 5px;\n"
"background-color:#0094ff;\n"
"font-weight: bold;\n"
...
""));
        ...
        horizontalLayout_4->addWidget(pauseButton_4);

        resumeButton_4 = new QPushButton(layoutWidget);
        resumeButton_4->setObjectName(QStringLiteral("resumeButton_4"));
        resumeButton_4->setEnabled(false);
        resumeButton_4->setStyleSheet(QLatin1String("QPushButton {\n"
"padding: 5px;\n"
"border-radius: 5px;\n"
"background-color:#0094ff;\n"
"font-weight: bold;\n"
...
"}"));
        ...
        horizontalLayout_4->addWidget(resumeButton_4);

        stopButton_4 = new QPushButton(layoutWidget);
        stopButton_4->setObjectName(QStringLiteral("stopButton_4"));
        stopButton_4->setStyleSheet(QLatin1String("QPushButton {\n"
"padding: 5px;\n"
"border-radius: 5px;\n"
"background-color:#0094ff;\n"
"font-weight: bold;\n"
...
"}"));
        ...
        horizontalLayout_4->addWidget(stopButton_4);

        plainTextEdit = new QPlainTextEdit(tab_3);
        plainTextEdit->setObjectName(QStringLiteral("plainTextEdit"));
        plainTextEdit->setGeometry(QRect(50, 30, 533, 180));
...
"}"));
        ...
        tabWidget_5->setGeometry(QRect(0, 0, 871, 481));
        tab_13 = new QWidget();
...
"}"));
        ...
        label_41 = new QLabel(tab_12);
        label_41->setObjectName(QStringLiteral("label_41"));
        label_41->setGeometry(QRect(60, 30, 271, 31));
        QFont font;
        font.setPointSize(11);
        font.setBold(true);
        font.setWeight(75);
        label_41->setFont(font);
        Recherche_Historique = new QLineEdit(tab_12);
        Recherche_Historique->setObjectName(QStringLiteral("Recherche_Historique"));
        Recherche_Historique->setGeometry(QRect(100, 70, 281, 31));
        Recherche_Historique->setStyleSheet(QLatin1String("QLineEdit {\n"
"padding: 5px;\n"
"border-radius: 5px;\n"
"\n"
"font-weight: bold;\n"
"}"));
        rdv_Historique = new QTextBrowser(tab_12);
        rdv_Historique->setObjectName(QStringLiteral("rdv_Historique"));
        rdv_Historique->setGeometry(QRect(60, 160, 471, 241));
        rdv_Historique->setFont(font);
        pushButton_8 = new QPushButton(tab_12);
        pushButton_8->setObjectName(QStringLiteral("pushButton_8"));
        pushButton_8->setGeometry(QRect(300, 110, 171, 31));
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_32->setText(QApplication::translate("MainWindow", "Engine", Q_NULLPTR));
        label_33->setText(QApplication::translate("MainWindow", "Volume:", Q_NULLPTR));
        label_34->setText(QApplication::translate("MainWindow", "Pitch:", Q_NULLPTR));
        label_35->setText(QApplication::translate("MainWindow", "Rate:", Q_NULLPTR));
        label_36->setText(QApplication::translate("MainWindow", "&Language:", Q_NULLPTR));
        label_37->setText(QApplication::translate("MainWindow", "Voice name:", Q_NULLPTR));
        speakButton_4->setText(QApplication::translate("MainWindow", "Speak", Q_NULLPTR));
        pauseButton_4->setText(QApplication::translate("MainWindow", "Pause", Q_NULLPTR));
        resumeButton_4->setText(QApplication::translate("MainWindow", "Resume", Q_NULLPTR));
        stopButton_4->setText(QApplication::translate("MainWindow", "Stop", Q_NULLPTR));
        plainTextEdit->setPlainText(QApplication::translate("MainWindow", "ajout fait avec succ\303\250s\n"
"\n"
"", Q_NULLPTR));
        tabWidget_7->setTabText(tabWidget_7->indexOf(tab_3), QApplication::translate("MainWindow", "Text To Speech", Q_NULLPTR));
        ...
        label_41->setText(QApplication::translate("MainWindow", "L'historique des rendez-vous", Q_NULLPTR));
        pushButton_8->setText(QApplication::translate("MainWindow", "Recherche Historique", Q_NULLPTR));
        tabWidget_5->setTabText(tabWidget_5->indexOf(tab_12), QApplication::translate("MainWindow", "Historique", Q_NULLPTR));
