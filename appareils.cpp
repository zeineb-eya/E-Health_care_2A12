...
query.bindValue(":EtatApp", EtatApp);
return query.exec();}
QSqlQueryModel* Appareils:: TriAppASC()
 {
     QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Appareils:: TriAppDES()
 {
     QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Appareils:: TriAppASC1()
 {
     QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Appareils:: TriAppDES1()
 {
     QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Appareils:: TriAppASC2()
 {
     QSqlQueryModel* model=new QSqlQueryModel();
...
QSqlQueryModel* Appareils:: TriAppDES2()
 {
     QSqlQueryModel* model=new QSqlQueryModel();
